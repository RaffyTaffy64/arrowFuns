...
console.log(fullName('', '', welcomeMessage))
// ===== DO NOT TOUCH CODE BELOW THIS LINE ===== //
...
const getAges = (arr) => {
  const result = arr.map((ageObj) => ageObj.age)
  // console.log(ageObj)
  return result
}
// this is to make your console.log work
// getAges [
//  {'name': 'Joe', 'age': 35},
//  {'name': 'Heather', 'age': 42},
//  {'name': 'Barry', 'age': 60}]
...
// or for a different way of writing it

//const getAges = (arr) => arr.map((ageObj) => ageObj.age)